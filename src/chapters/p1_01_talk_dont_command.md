...
Today the practice looks roughly like this, and it will look different by the time you read it. An idea arrives, vague or concrete. We talk. If it's concrete, we blueprint it on the spot and ratify it. If it's vague, we counsel first, talking until the vision has edges, and only then blueprint and phase it. Either way I set the model loose on a phase, and I watch where it goes.
...
That shape is not new, and it is not mine. Before the world was made, the thing to be made was envisioned in full — created spiritually before a particle of it was moved ([Moses 3:5](../../gospel-library/eng/scriptures/pgp/moses/3.md?verse=5)). [qr](../../gospel-library/eng/scriptures/pgp/moses/3.md?verse=5) The conversation that finds your vision is the small, daily shadow of that first seeing. Where the seeing happened, in counsel, is the next practice. (Part Two: Intent · Spiritual Creation — the doctrine under this practice.)
