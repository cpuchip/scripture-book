...
1. **AI-content disclosure** — the most important honesty call, and it has teeth (undisclosed AI-generated content can get a title pulled and an account suspended). KDP's line:
   ...
   - **✅ DECIDED 2026-06-04 (Michael): disclose Text as AI-generated.** His framing — *"AI generated, human-assisted review… it's the inverse"* — names it exactly: the prose was AI-drafted from his studies/intent, with the human doing the assisting (review, verification, correction), the inverse of the usual "human writes, AI assists." This is the honest call and it matches the book, which is openly about human–AI collaboration. **At KDP: check the Text = AI-generated box.** If the final cover art is AI-made, check Images too (the typographic cover I'm building is not AI-*generated* imagery — it's typeset — so if we ship that, Images = no).
